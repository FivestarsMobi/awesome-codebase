            ...
            <div class="row no-gutters w-100 py-100 overflow-hidden">
                <div class="col-md-5 py-30 d-flex align-items-center invisible" data-toggle="appear">
                    <div class="text-center text-md-left">
                        <span class="d-inline-block bg-body-light rounded-pill py-5 px-15 mb-15 font-w600">Version <?php echo $cb->version; ?></span>
...
<div class="bg-white">
    <div class="content content-full text-center overflow-hidden">
        <div class="py-100">
            ...
            <h3 class="h4 font-w400 text-muted mb-50">Passionate web design and development with over 13.000 customers worldwide.</h3>
